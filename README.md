...
# Anushka Portfolio Showcase 💻

Welcome to **Anushka's Portfolio Showcase**!  
...
You can view the live website here: [Live Demo](https:)
...
- Email: selenophilexanu@gmail.com   
- Location: India, Up  
- LinkedIn: [LinkedIn](https://www.linkedin.com/in/)  
- GitHub: [GitHub](https://github.com/Anushkazonexd)  
- Instagram: [Instagram](https://www.instagram.com/)

---

Made with ❤️ by **Anushka Zone**


```bash
git clone https://github.com/Anushkazonexd/portfolio-showcase.git
